<?php
/*
Template Name: API Package Transfers Page
*/
?>
    ...
    <section class="booking text--color--dark">
        <?php if($order): ?>
          ...
          <div class="booking__col-content">
            <?php do_action('order_content_header' , 'transfers' , $order , $api); ?>
            <?php get_template_part('template-parts/api/packages/package','transfers',  array(
              'api' => $api,
              'order' => $order,
            )); ?>
          </div>
