<?php
/*
Template Name: API Package Extras Page
*/
?>
    ...
    <section class="booking text--color--dark">
        <?php if($order): ?>
          ...
          <div class="booking__col-content">
            <?php do_action('order_content_header' , 'extras' , $order , $api); ?>
            <?php get_template_part('template-parts/api/packages/package','extras',  array(
              'api' => $api,
              'order' => $order,
            )); ?>
          </div>
