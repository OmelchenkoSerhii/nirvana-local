<?php
/**
 * Template Name: API Package Single
 */
?>
	...
	<section class="booking text--color--dark">
		<?php if($order): ?>
			...
			<div class="booking__col-content px-2">
				<?php do_action('order_content_header' , 'package' , $order , $api); ?>
				<?php get_template_part( 'template-parts/api/packages/order', 'package-single',  array(
					'api' => $api,
					'order' => $order,
				)); ?>
			</div>
