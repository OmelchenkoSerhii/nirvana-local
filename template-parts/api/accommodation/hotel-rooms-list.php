...
?>
<section id="rooms" class="hotel-rooms-list js-rooms-search py-8 px-1 px-xl-5" data-hotel="<?php echo $hotelPostID; ?>" data-hotelcode="<?php echo $hotelCode; ?>" data-order="<?php echo $order->getOrderNumber(); ?>">
	...
	<form id="rooms-reserve-form" method="POST" action="<?php echo $link; ?>" class="hotel-rooms-list__content mt-2 position-relative hotel-single-form">
		...
		<div class="js-rooms-list" data-nights="<?php echo $hotelMinNights; ?>">
			<?php if($rooms): ?>
				<?php 
				get_template_part(
